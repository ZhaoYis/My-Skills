...
const scenario: ScenarioConfig = {
  name: 'cursor-fullstack-todo-delivery',
...
describe('E2E - Full gated delivery (Cursor)', () => {
  ...
  it('executes all seven phases without synthetic or skipped results (Cursor)', () => {
  ...
  it('runs post-merge tests and leaves both remote refs available (Cursor)', async () => {
  ...
  it('generates schema-valid JSON and Markdown reports from real results (Cursor)', async () => {
