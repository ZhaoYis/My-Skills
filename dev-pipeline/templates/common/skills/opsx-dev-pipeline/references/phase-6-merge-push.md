...
description: 全局步骤 17–22（预提交 5a/5b、提交决策点 5、推送 5c、合并决策点 6、合并后、最终摘要）。须先完成 phase-5-unit-tests.md 步骤 16 与 phase-4-archive.md 步骤 12–16。
