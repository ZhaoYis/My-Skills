...
export const assetManifest: AssetDefinition[] = [
  ...
  {
    id: 'knowledge-base-bundle',
    kind: 'bundle',
    scope: 'common',
    feature: 'base',
    source: 'templates/common/knowledge',
    destination: 'openspec/knowledge',
    includeExtensions: ['.md', '.json', '.mjs'],
  ...
  },
  {
    ...
    scope: 'common',
    feature: 'skills',
    source: 'templates/common/skills/kb',
    destination: '{{skillsDir}}/kb',
    includeExtensions: ['.md', '.yaml'],
    excludePatterns: ['.gitkeep'],
    writePolicy: { appendStrategy: 'simple', appendExtensions: ['.md'] },
  },
  ...
  },
  {
    ...
    scope: 'common',
    feature: 'commands',
    source: 'templates/common/commands/opsx/grill-me.md.hbs',
  ...
  },
  {
    ...
    scope: 'common',
    feature: 'commands',
    source: 'templates/common/commands/opsx/grilling.md.hbs',
  ...
  },
  {
    ...
    scope: 'common',
    feature: 'commands',
    source: 'templates/common/commands/opsx/kb.md.hbs',
    destination: '{{commandsDir}}/opsx/kb.md',
    writePolicy: { appendStrategy: 'simple', onConflict: { init: 'overwrite' } },
  },
  {
    id: 'claude-docs',
