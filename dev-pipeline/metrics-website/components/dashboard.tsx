    ...
    <>
      ...
      <div className="workspace">
        ...
        <section className="page-heading">
          ...
          {data.totalRuns > 0 && <div className="completion-dial"><strong>{percent(data.completionRate)}</strong><span>总完成率</span></div>}
        </section>

        {data.totalRuns === 0 ? (
          <RequestState compact detail={emptyDetail} kind={emptyKind} />
        ) : (
          <>
