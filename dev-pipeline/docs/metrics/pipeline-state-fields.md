...
| `fingerprintId` | `string` | 是 | v2+ | 否 | MD5 指纹哈希（32 位 hex） |
| `fingerprintNonce` | `string` | 是 | v2+ | 否 | 指纹随机盐（8 位 hex） |
...
```json
{
  ...
  "fingerprintId": "fecee4ad63d1331283db2da237618f89",
